# Есть несколько экспериментов, их было удобно разбить на несколько файлов.
...
и находится файл main.py. Предложенный мною в статье метод реализован в файле adamwh.py, для запуска нужна библиотека pytorch.
